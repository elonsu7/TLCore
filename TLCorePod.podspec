...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhanqijie/TLCorePod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhanqijie' => 'jasonjie.zhan@tron.network' }
  s.source           = { :git => 'https://github.com/zhanqijie/TLCorePod.git', :tag => s.version.to_s }
